...
public class Product implements Serializable{
	...
	//Set diferente da lista, é para garantir que um produto não tenha 2 categorias iguais.
	// new HashSet<>(); => Garantir que minha coleção não começe null, ela tem que começar vazia,
	// e não instanciada.
	// Porque usamos então,HashSet<> AO INVES do SET?
	// R: Porque o Set é uma interface, ele não pode ser instanciado.
